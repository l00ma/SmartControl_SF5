...
function parseAndDisplay(data) {
	...
	document.getElementById("temp").innerHTML = '<div class="container me-3 text-center"> <div class="row"> <div class="col moyenne text-end" title="température"> <i class="wi wi-thermometer"></i> </div> <div class="col" title="temp bas:' + data.temp_bas + '"><span class="petite">ext </span><span class="moyenne">' + data.temp_ext + '</span><span class="petite"> °c</span> </div> <div class="col"> <span class="petite">int </span><span class="moyenne">' + data.temp_int + '</span><span class="petite"> °c</span> </div> </div> <div class="row"> <div class="col-4 moyenne text-end" title="humidité"> <i class="wi wi-humidity"></i> </div> <div class="col-8"> <span class="moyenne" title="humidité">' + data.humidite + '</span><span class="petite"> %</span> </div> </div> <div class="row"> <div class="col-4 moyenne text-end" title="pression"> <i class="wi wi-barometer"></i> </div> <div class="col-8"> <span class="moyenne" title="pression">' + data.pression + '</span><span class="petite"> Hpa</span> </div> </div> <div class="row"> <div class="col moyenne text-end" title="vent"> <i class="wi wi-strong-wind"></i> </div> <div class="col text-end"> <span class="moyenne" title="vent">' + data.vitesse_vent + '</span><span class="petite"> km/h</span> </div> <div class="col text-start"> <span class="moyenne">' + data.direction_vent + '</span> </div> </div> <div class="row"> <div class="col text-end"> <i class="wi wi-sunrise" title="heure de levé du soleil"></i><span class="moyenne">' + data.leve_soleil + '</span> </div> <div class="col text-start"> <i class="wi wi-sunset" title="heure de couché du soleil"></i><span class="moyenne">' + data.couche_soleil + '</span> </div> </div> </div>';
...
document.addEventListener("DOMContentLoaded", function () {
	...
	document.getElementById("haltBtn").addEventListener("click", function (){
		alert("halt");
	});
});
