...
function parseAndDisplay(data) {
	...
	document.getElementById("temp").innerHTML = '<table><tr><td class="moyenne" title="température"><i class="wi wi-thermometer"></i></td><td title="temp bas:' + data.temp_bas + '" ><span class="petite">ext </span><span class="moyenne">' + data.temp_ext + '</span><span class="petite"> °c</span>&nbsp;&nbsp;&nbsp;<span class="petite">int </span><span class="moyenne">' + data.temp_int + '</span><span class="petite"> °c</span></td></tr><tr><td class="moyenne" title="humidité"><i class="wi wi-humidity"></i></td><td><span class="moyenne" title="humidité">' + data.humidite + '</span><span class="petite"> %</span></td></tr><tr><td class="moyenne" title="pression"><i class="wi wi-barometer"></i></td><td><span class="moyenne" title="pression">' + data.pression + '</span><span class="petite"> Hpa</span></td></tr><tr><td class="moyenne" title="vent"><i class="wi wi-strong-wind"></i></td><td><span class="moyenne" title="vent">' + data.vitesse_vent + '</span><span class="petite"> km/h</span>&nbsp;&nbsp;&nbsp;<span class="moyenne">' + data.direction_vent + '</span></td></tr><tr><td colspan="2" ><i class="wi wi-sunrise" title="heure de levé du soleil"></i>&nbsp;&nbsp;<span class="moyenne">' + data.leve_soleil + '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="wi wi-sunset" title="heure de couché du soleil"></i>&nbsp;&nbsp;<span class="moyenne">' + data.couche_soleil + '</span></td></tr></table>';
